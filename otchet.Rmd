...
Как можно видеть по графику, величина MSE при методе k ближайших соседей становится то больше, то меньше, по сравнению с этим значнеием у линейной регрессии и стабилизируется только при большом значении k. Модель можно использовать для прогноза, относительно низкое значение MSE.