...
Как можно видеть по графику, очевидна автокорреляция и поэтому данную модель не рекомендуется использоваться для прогнозирования. Величина MSE при методе k ближайших соседей становится то больше, то меньше, по сравнению с этим значнеием у линейной регрессии и стабилизируется только при большом значении k.